<section id="section-portal-menu" class="py-3">
    <h5 class="fw-bolder mb-3" style="font-size: 24px">Portal Sistem</h5>
    <div class="row row-cols-2 row-cols-sm-3 row-cols-lg-6 g-3 text-center">
        ...
        <div class="col">
            <img src="{{ asset('assets/dist/images/portal-menu/img-edukai.svg') }}" alt="image-edukai" onclick="#"
                class="portal-menu">
        </div>
        <div class="col">
            <img src="{{ asset('assets/dist/images/portal-menu/img-self-assesment.svg') }}" alt="image-self-assesment"
                class="portal-menu">
        </div>
        <div class="col">
