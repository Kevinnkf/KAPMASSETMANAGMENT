...
<p style="position:absolute;top:270px;left:231px;white-space:nowrap" class="ft13">:&#160;BAP.SR.{{ str_replace('-', '', $selectedRecord['dateadded'] ?? 'N/A') }}&#160;</p>
<p style="position:absolute;top:291px;left:62px;white-space:nowrap" class="ft13">Tanggal&#160;</p>
<p style="position:absolute;top:291px;left:231px;white-space:nowrap" class="ft13">:&#160;{{$selectedRecord['dateadded'] ?? 'N/A'}}</p>
...
<p style="position:absolute;top:352px;left:189px;white-space:nowrap" class="ft13">:</p>
<p style="position:absolute;top:352px;left:210px;white-space:nowrap" class="ft13">{{ $selectedRecord['assetcode'] ?? 'N/A' }}</p>
<p style="position:absolute;top:352px;left:490px;white-space:nowrap" class="ft13">Tanggal Perbaikan</p>
<p style="position:absolute;top:352px;left:630px;white-space:nowrap" class="ft13">:</p>
<p style="position:absolute;top:352px;left:650px;white-space:nowrap" class="ft13">{{ $selectedRecord['dateadded'] ?? 'N/A' }}</p>
<p style="position:absolute;top:382px;left:61px;white-space:nowrap" class="ft13">Serial Number</p>
<p style="position:absolute;top:382px;left:189px;white-space:nowrap" class="ft13">:</p>
<p style="position:absolute;top:382px;left:210px;white-space:nowrap" class="ft13">{{ $selectedRecord['trnasset']['assetserialnumber'] ?? 'N/A' }}</p>
<p style="position:absolute;top:382px;left:490px;white-space:nowrap" class="ft13">Jenis Perangkat</p>
<p style="position:absolute;top:382px;left:636px;white-space:nowrap" class="ft13">:</p>
<p style="position:absolute;top:382px;left:650px;white-space:nowrap" class="ft13">{{ $selectedRecord['trnasset']['assettype'] ?? 'N/A' }}</p>
<p style="position:absolute;top:436px;left:53px;white-space:nowrap" class="ft13">&#160;</p>
    

<p style="position:absolute;top:454px;left:62px;white-space:nowrap" class="Suku cadang yang digunakan"><b>Tindakan&#160;Perbaikan&#160;</b>–&#160;<i>diisikan oleh&#160;Pelaksana&#160;Perbaikan</i>&#160;</p>
<p style="position:absolute;top:489px;left:62px;white-space:nowrap" class="ft14">{{ $selectedRecord['notesaction'] ?? 'N/A' }}&#160;</p>
...
<p style="position:absolute;top:640px;left:62px;white-space:nowrap" class="ft14">{{ $selectedRecord['notessparepart'] ?? 'N/A' }}&#160;</p>
...
<p style="position:absolute;top:800px;left:62px;white-space:nowrap" class="ft14">{{ $selectedRecord['notesresult'] ?? 'N/A' }}&#160;</i></p>
...
<p style="position:absolute;top:149px;left:703px;white-space:nowrap" class="ft17">:&#160;{{ $selectedRecord['dateadded'] ?? 'N/A' }}&#160;</p>
...
<p style="position:absolute;top:1080px;left:149px;white-space:nowrap" class="ft14"><b>{{ $selectedRecord['trnasset']['picadded'] }}&#160;</b></p>
...
<p style="position:absolute;top:1080px;left:520px;white-space:nowrap" class="ft14"><b>MEILINA RACHMAWATI&#160;</b></p>
<p style="position:absolute;top:1110px;left:560px;white-space:nowrap" class="ft14"><b>Nippm.&#160;21750397&#160;</b></p>
        ...
        <table style="width: 100%; border: none; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: center; border: none; padding-bottom: 80px;">
                    ...
                    <p class="ft13" style="text-decoration: underline"><b>{{ $selectedRecord['employee']['name'] ?? 'N/A' }}&#160;</b></p>
                    <p class="ft13"><b>Nippm.&#160;{{ $selectedRecord['employee']['nipp'] ?? 'N/A' }}</b>&#160;</p>
                </td>
            </tr>
        </table>
    </div>
