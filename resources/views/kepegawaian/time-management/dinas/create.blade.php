                    ...
                    <div class="card-body pt-0">
                        @foreach ($data as $item)
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" placeholder="Nama pegawai" value="{{ $item['nama'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="nipp">NIPP</label>
                                <input type="text" class="form-control" id="nipp" placeholder="Nomor NIPP" value="{{ $item['nipp'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="jabatan">Jabatan</label>
                                <input type="text" class="form-control" id="jabatan" placeholder="Jabatan anda" value="{{ $item['jabatan'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="unitKerja">Unit Kerja</label>
                                <input type="text" class="form-control" id="unitKerja" placeholder="Unit kerja" value="{{ $item['unitKerja'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="emailPegawai">Email</label>
                                <input type="email" class="form-control" id="emailPegawai" placeholder="Email" value="{{ $item['email'] }}" readonly>
                            </div>
                            <hr>
                            <div class="py-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenisDinas" id="dinasDalam"
                                        value="dalam">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenisDinas" id="dinasLuar"
                                        value="luar" checked>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="namaAtasan" placeholder="Nama atasan" value="{{ $item['namaAtasan'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="nippAtasan">NIPP</label>
                                <input type="text" class="form-control" id="nippAtasan" placeholder="Nomor NIPP" value="{{ $item['nippAtasan'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="jabatanAtasan">Jabatan Atasan</label>
                                <input type="text" class="form-control" id="jabatanAtasan"
                                    placeholder="Jabatan atasan" value="{{ $item['posisiAtasan'] }}" readonly>
                            </div>
                            <div class="mb-3">
                                <label for="emailAtasan">Email</label>
                                <input type="email" class="form-control" id="posisiAtasan" placeholder="Email" value="{{ $item['emailAtasan'] }}" readonly>
                            </div>
                            <div class="d-flex justify-content-start">
                                <button type="button" class="btn btn-secondary me-2">Kembali</button>
                                <button type="submit" class="btn btn-primary" id="ajukan"
                                    onclick="validateForm()">Ajukan</button>
                            </div>
                    </div>
                    @endforeach
                </div>
