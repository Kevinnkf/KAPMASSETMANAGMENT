...
@section('content')
    ...
    <div class="py-3">
        <div class="esa-header">
            <div class="esa-header-dark">Add Image Data</div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('transaction.image.store', ['assetcode' => $assetcode]) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <!-- Data Pegawai -->
                    <h4 class="esa-title">Image Fields</h4>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="picadded" class="form-label esa-label">PIC</label>
                            <input type="text" class="form-control @error('picadded') is-invalid @enderror" id="picadded" name="picadded" value="{{ $data['nama'] }}" placeholder="Person In Charge" required readonly>
                            @error('picadded')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    <label for="lampiran" class="form-label esa-label">Upload Image</label>
                    <div class="mb-4">
                        <input 
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var myDropzone = new Dropzone("#file-dropzone", {
                        url: "{{ route('transaction.image.store', ['assetcode' => $assetcode]) }}", // Set this to your upload route
                        paramName: "assetimage", // Name of the input for the file
                        maxFilesize: 10, // Max file size in MB
                        acceptedFiles: ".jpg,.jpeg,.png", // Allowed file types
                        autoProcessQueue: false, // Automatically upload the file
